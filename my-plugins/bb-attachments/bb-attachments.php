...
$bb_attachments['allowed']['extensions']['default']=array('gif','jpeg','jpg','pdf','png','txt', 'war', 'jar', 'zip', 'gz');	// anyone who can upload can submit these
...
$bb_attachments['allowed']['mime_types']['default']=array('application/octet-stream', 'text/plain', 'text/x-c', 'image/bmp', 'image/jpeg', 'image/jpg', 'image/png', 'image/gif', 'application/pdf', 'application/x-pdf', 'application/zip', 'application/x-zip' , 'application/x-gzip');
...
$bb_attachments['max']['size']['default']=5000*1024;	   // general max for all type/roles, in bytes (ie. 100k)
...
$bb_attachments['max']['size']['administrate']=50000*1024; // size limit override by role, bytes (ie. 500k) - note this overrides ALL extension limits
